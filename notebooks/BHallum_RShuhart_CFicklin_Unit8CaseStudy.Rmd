...
median_age_by_sex_line <- ggplot(median_age_by_sex, aes(x=Year, y=Med_Age, color = Sex)) + 
  ...
  labs(title="(Fig. #) Median Age by Sex")
...
ggplot(run_data, aes(Year, fill=AgeCat)) + 
  ...
  labs(title="(Fig. #) Proportion of Age Groups by Year")
```
...
m_den1 <- ggplot(male_data, aes(x=Year, y=Age))  +
  ...
  labs(title="(Fig. #) Density Heat Map for Men")
...
f_den1 <- ggplot(fem_data, aes(x=Year, y=Age))  +
  ...
  labs(title="(Fig. #) Density Heat Map for Women")
...
m_den2 <- ggplot(male_data, aes(Age, color = as.factor(Year))) +
  ...
  labs(title="(Fig. #) Distribution Density of Age for Men")
...
f_den2 <- ggplot(fem_data, aes(Age, color = as.factor(Year))) +
  ...
  labs(title="(Fig. #) Distribution Density of Age for Women")
